...
class GamesViewHolder (view: View) : RecyclerView.ViewHolder(view){
    ...
    private var tvGame: TextView = view.findViewById(R.id.tvGame)
    private val checkBox: CheckBox = view.findViewById(R.id.cbGame)
    ...
    fun render(game: Game){
        ...
        checkBox.isChecked = game.isSelected
    ...
    checkBox.buttonTintList =
        ColorStateList.valueOf(ContextCompat.getColor(checkBox.context, color))
